...
#define MTDPARTS_DEFAULT		"mtdparts=gpmi-nand:4m(boot),1m(dtb),8m(kernel),8m(kernel-bk),4m(logo),73m(rootfs),-(custom)"
#define UBOOT_PARTITION_SIZE		SZ_4M
#define DTB_PARTITION_SIZE		SZ_1M
#define KERNEL_PARTITION_SIZE		SZ_8M

#ifdef CONFIG_SYS_BOOT_NAND
#define CONFIG_MFG_NAND_PARTITION	MTDPARTS_DEFAULT " "
#else
...
#define CONFIG_ENV_OFFSET		(UBOOT_PARTITION_SIZE - CONFIG_ENV_SIZE)
